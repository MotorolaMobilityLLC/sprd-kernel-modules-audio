...
EXPORT_SYMBOL(aon_apb_gpr_null_check);

void arch_audio_set_aon_apb_gpr(struct regmap *gpr)
{
	aon_apb_gpr = gpr;
}
EXPORT_SYMBOL(arch_audio_set_aon_apb_gpr);

struct regmap *arch_audio_get_aon_apb_gpr(void)
{
	return aon_apb_gpr;
}
EXPORT_SYMBOL(arch_audio_get_aon_apb_gpr);
/*
...
EXPORT_SYMBOL(agcp_ahb_gpr_null_check);

void arch_audio_set_agcp_ahb_gpr(struct regmap *gpr)
{
	g_agcp_ahb_gpr = gpr;
}
EXPORT_SYMBOL(arch_audio_set_agcp_ahb_gpr);

struct regmap *arch_audio_get_agcp_ahb_gpr(void)
{
	return g_agcp_ahb_gpr;
}
EXPORT_SYMBOL(arch_audio_get_agcp_ahb_gpr);
...
EXPORT_SYMBOL(pmu_apb_gpr_null_check);

void arch_audio_set_pmu_apb_gpr(struct regmap *gpr)
{
	pmu_apb_gpr = gpr;
}
EXPORT_SYMBOL(arch_audio_set_pmu_apb_gpr);

struct regmap *arch_audio_get_pmu_apb_gpr(void)
{
	return pmu_apb_gpr;
}
EXPORT_SYMBOL(arch_audio_get_pmu_apb_gpr);
...
EXPORT_SYMBOL(pmu_com_apb_gpr_null_check);

void arch_audio_set_pmu_com_apb_gpr(struct regmap *gpr)
{
	pmu_com_apb_gpr = gpr;
}
EXPORT_SYMBOL(arch_audio_set_pmu_com_apb_gpr);

struct regmap *arch_audio_get_pmu_com_apb_gpr(void)
{
	return pmu_com_apb_gpr;
}
EXPORT_SYMBOL(arch_audio_get_pmu_com_apb_gpr);
...
EXPORT_SYMBOL(ap_apb_gpr_null_check);

void arch_audio_set_ap_apb_gpr(struct regmap *gpr)
{
	g_ap_apb_gpr = gpr;
}
EXPORT_SYMBOL(arch_audio_set_ap_apb_gpr);

struct regmap *arch_audio_get_ap_apb_gpr(void)
{
	return g_ap_apb_gpr;
}
EXPORT_SYMBOL(arch_audio_get_ap_apb_gpr);
...
EXPORT_SYMBOL(anlg_phy_g_null_check);

void arch_audio_set_anlg_phy_g(struct regmap *gpr)
{
	anlg_phy_g = gpr;
}
EXPORT_SYMBOL(arch_audio_set_anlg_phy_g);

struct regmap *arch_audio_get_anlg_phy_g(void)
{
	return anlg_phy_g;
}
EXPORT_SYMBOL(arch_audio_get_anlg_phy_g);
