...
#ifndef __SPRD_AUDIO_UMP9620_H
#define __SPRD_AUDIO_UMP9620_H

#include <linux/mfd/syscon.h>
#include <linux/regmap.h>
#include "sprd-audio.h"

#define ADEBUG() pr_info("%s %d\n", __func__, __LINE__)

#define CODEC_CHIP_ID 0x7520

#define MASK_ANA_VER	0xFFFF

#define CTL_BASE_ANA_GLB                        0x2000
