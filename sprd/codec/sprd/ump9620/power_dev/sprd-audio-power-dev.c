/*
 * audio/sprd/codec/sprd/sc2730/sprd-audio-power.c
 *
...
static int sprd_audio_power_add_devices(void)
{
	...
	if (!of_device_is_available(np)) {
		pr_info(" node 'unisoc,ump9620-audio-codec' is disabled.\n");
		return 0;
	}
