...
#define sprd_is_normal_scene(cpu_dai_id) \
	(((cpu_dai_id) == BE_DAI_ID_NORMAL_AP01_CODEC) ||\
	  ((cpu_dai_id) == BE_DAI_ID_NORMAL_AP01_USB))
...
static char *be_dai_id_aif_name_playback[BE_DAI_ID_MAX] = {
	[BE_DAI_ID_NORMAL_AP01_CODEC] = "BE_IF_NORMAL_AP01_CODEC_P",
	[BE_DAI_ID_NORMAL_AP23_CODEC] = "BE_IF_NORMAL_AP23_CODEC_P",
	[BE_DAI_ID_CAPTURE_DSP_CODEC] = NULL,
	[BE_DAI_ID_FAST_P_CODEC] = "BE_IF_FAST_CODEC_P",
	[BE_DAI_ID_OFFLOAD_CODEC] = "BE_IF_OFFLOAD_CODEC_P",
	[BE_DAI_ID_VOICE_CODEC] = "BE_IF_VOICE_CODEC_P",
	[BE_DAI_ID_VOIP_CODEC] = "BE_IF_VOIP_CODEC_P",
	[BE_DAI_ID_FM_CODEC] = "BE_IF_FM_CODEC_P",
	[BE_DAI_ID_LOOP_CODEC] = "BE_IF_LOOP_CODEC_P",
	[BE_DAI_ID_NORMAL_AP01_USB] = "BE_IF_NORMAL_AP01_USB_P",
	[BE_DAI_ID_NORMAL_AP23_USB] = "BE_IF_NORMAL_AP23_USB_P",
	[BE_DAI_ID_CAPTURE_DSP_USB] = NULL,
	[BE_DAI_ID_FAST_P_USB] = "BE_IF_FAST_USB_P",
	[BE_DAI_ID_OFFLOAD_USB] = "BE_IF_OFFLOAD_USB_P",
	[BE_DAI_ID_VOICE_USB] = "BE_IF_VOICE_USB_P",
	[BE_DAI_ID_VOIP_USB] = "BE_IF_VOIP_USB_P",
	[BE_DAI_ID_FM_USB] = "BE_IF_FM_USB_P",
	[BE_DAI_ID_LOOP_USB] = "BE_IF_LOOP_USB_P",
	[BE_DAI_ID_OFFLOAD_A2DP] = "BE_IF_OFFLOAD_A2DP_P",
	[BE_DAI_ID_PCM_A2DP] = "BE_IF_PCM_A2DP_P",
	[BE_DAI_ID_VOICE_BT] = "BE_IF_VOICE_BT_P",
	[BE_DAI_ID_VOIP_BT] = "BE_IF_VOIP_BT_P",
	[BE_DAI_ID_LOOP_BT] = "BE_IF_LOOP_BT_P",
	[BE_DAI_ID_CAPTURE_BT] = NULL,
	[BE_DAI_ID_VOICE_CAPTURE] = NULL,
	[BE_DAI_ID_FM_CAPTURE] = NULL,
	[BE_DAI_ID_FM_CAPTURE_DSP] = NULL,
	[BE_DAI_ID_CAPTURE_DSP_BTSCO] = NULL,
	[BE_DAI_ID_FM_DSP_CODEC] = "BE_IF_FM_DSP_CODEC_P",
	[BE_DAI_ID_FM_DSP_USB] = "BE_IF_FM_DSP_USB_P",
	[BE_DAI_ID_DUMP] = NULL,
	[BE_DAI_ID_FAST_P_BTSCO] = "BE_IF_FAST_BTSCO_P",
	[BE_DAI_ID_NORMAL_AP01_P_BTSCO] = "BE_IF_NORMAL_AP01_BTSCO_P",
	[BE_DAI_ID_NORMAL_AP01_P_HIFI] = "BE_IF_NORMAL_AP01_HIFI_P",
	[BE_DAI_ID_NORMAL_AP23_HIFI] = "BE_IF_ID_NORMAL_AP23_HIFI",
	[BE_DAI_ID_FAST_P_HIFI] = "BE_IF_ID_FAST_P_HIFI",
	[BE_DAI_ID_OFFLOAD_HIFI] = "BE_IF_ID_OFFLOAD_HIFI",
	[BE_DAI_ID_VOICE_HIFI] = "BE_IF_ID_VOICE_HIFI",
	[BE_DAI_ID_VOIP_HIFI] = "BE_IF_ID_VOIP_HIFI",
	[BE_DAI_ID_FM_HIFI] = "BE_IF_ID_FM_HIFI",
	[BE_DAI_ID_LOOP_HIFI] = "BE_IF_ID_LOOP_HIFI",
	[BE_DAI_ID_FM_DSP_HIFI] = "BE_IF_ID_FM_DSP_HIFI",
	[BE_DAI_ID_HFP] = "BE_IF_HFP_P",
	[BE_DAI_ID_RECOGNISE_CAPTURE] = NULL,
	[BE_DAI_ID_VOICE_PCM_P] = "BE_IF_VOICE_PCM_P",
	[BE_DAI_ID_NORMAL_AP01_P_SMTPA] = "BE_IF_NORMAL_AP01_SMTPA_P",
	[BE_DAI_ID_NORMAL_AP23_SMTPA] = "BE_IF_ID_NORMAL_AP23_SMTPA",
	[BE_DAI_ID_FAST_P_SMTPA] = "BE_IF_ID_FAST_P_SMTPA",
	[BE_DAI_ID_FAST_P_SMART_AMP] = "BE_IF_ID_FAST_P_SMART_AMP",
	[BE_DAI_ID_OFFLOAD_SMTPA] = "BE_IF_ID_OFFLOAD_SMTPA",
	[BE_DAI_ID_VOICE_SMTPA] = "BE_IF_ID_VOICE_SMTPA",
	[BE_DAI_ID_VOIP_SMTPA] = "BE_IF_ID_VOIP_SMTPA",
	[BE_DAI_ID_FM_SMTPA] = "BE_IF_ID_FM_SMTPA",
	[BE_DAI_ID_LOOP_SMTPA] = "BE_IF_ID_LOOP_SMTPA",
...
static char *be_dai_id_aif_name_capture[BE_DAI_ID_MAX] = {
	[BE_DAI_ID_NORMAL_AP01_CODEC] = "BE_IF_NORMAL_AP01_CODEC_C",
	[BE_DAI_ID_NORMAL_AP23_CODEC] = "BE_IF_NORMAL_AP23_CODEC_C",
	[BE_DAI_ID_CAPTURE_DSP_CODEC] = "BE_IF_CAP_DSP_CODEC_C",
	[BE_DAI_ID_FAST_P_CODEC] = NULL,
	[BE_DAI_ID_OFFLOAD_CODEC] = NULL,
	[BE_DAI_ID_VOICE_CODEC] = "BE_IF_VOICE_CODEC_C",
	[BE_DAI_ID_VOIP_CODEC] = "BE_IF_VOIP_CODEC_C",
	[BE_DAI_ID_FM_CODEC] = NULL,
	[BE_DAI_ID_LOOP_CODEC] = "BE_IF_LOOP_CODEC_C",
	[BE_DAI_ID_NORMAL_AP01_USB] = "BE_IF_NORMAL_AP01_USB_C",
	[BE_DAI_ID_NORMAL_AP23_USB] = "BE_IF_NORMAL_AP23_USB_C",
	[BE_DAI_ID_CAPTURE_DSP_USB] = "BE_IF_CAP_DSP_USB_C",
	[BE_DAI_ID_FAST_P_USB] = NULL,
	[BE_DAI_ID_OFFLOAD_USB] = NULL,
	[BE_DAI_ID_VOICE_USB] = "BE_IF_VOICE_USB_C",
	[BE_DAI_ID_VOIP_USB] = "BE_IF_VOIP_USB_C",
	[BE_DAI_ID_FM_USB] = NULL,
	[BE_DAI_ID_LOOP_USB] = "BE_IF_LOOP_USB_C",
	[BE_DAI_ID_OFFLOAD_A2DP] = NULL,
	[BE_DAI_ID_PCM_A2DP] = NULL,
	[BE_DAI_ID_VOICE_BT] = "BE_IF_VOICE_BT_C",
	[BE_DAI_ID_VOIP_BT] = "BE_IF_VOIP_BT_C",
	[BE_DAI_ID_LOOP_BT] = "BE_IF_LOOP_BT_C",
	[BE_DAI_ID_CAPTURE_BT] = "BE_IF_CAP_BT_C",
	[BE_DAI_ID_VOICE_CAPTURE] = "BE_IF_VOICE_CAP_C",
	[BE_DAI_ID_FM_CAPTURE] = "BE_IF_CAP_FM_CAP_C",
	[BE_DAI_ID_FM_CAPTURE_DSP] = "BE_IF_CAP_DSP_FM_C",
	[BE_DAI_ID_CAPTURE_DSP_BTSCO] = "BE_IF_CAP_DSP_BTSCO_C",
	[BE_DAI_ID_FM_DSP_CODEC] = NULL,
	[BE_DAI_ID_FM_DSP_USB] = NULL,
	[BE_DAI_ID_DUMP] = "BE_IF_DUMP_C",
	[BE_DAI_ID_FAST_P_BTSCO] = NULL,
	[BE_DAI_ID_NORMAL_AP01_P_BTSCO] = NULL,
	[BE_DAI_ID_NORMAL_AP01_P_HIFI] = NULL,
	[BE_DAI_ID_NORMAL_AP23_HIFI] = NULL,
	[BE_DAI_ID_FAST_P_HIFI] = NULL,
	[BE_DAI_ID_OFFLOAD_HIFI] = NULL,
	[BE_DAI_ID_VOICE_HIFI] = NULL,
	[BE_DAI_ID_VOIP_HIFI] = NULL,
	[BE_DAI_ID_FM_HIFI] = NULL,
	[BE_DAI_ID_LOOP_HIFI] = NULL,
	[BE_DAI_ID_FM_DSP_HIFI] = NULL,
	[BE_DAI_ID_HFP] = "BE_IF_HFP_C",
	[BE_DAI_ID_RECOGNISE_CAPTURE] = "BE_IF_CAP_RECOGNISE_CODEC_C",
	[BE_DAI_ID_VOICE_PCM_P] = NULL,
	[BE_DAI_ID_NORMAL_AP01_P_SMTPA] = NULL,
	[BE_DAI_ID_NORMAL_AP23_SMTPA] = NULL,
	[BE_DAI_ID_FAST_P_SMTPA] = NULL,
	[BE_DAI_ID_FAST_P_SMART_AMP] = NULL,
	[BE_DAI_ID_OFFLOAD_SMTPA] = NULL,
	[BE_DAI_ID_VOICE_SMTPA] = NULL,
	[BE_DAI_ID_VOIP_SMTPA] = NULL,
	[BE_DAI_ID_FM_SMTPA] = NULL,
	[BE_DAI_ID_LOOP_SMTPA] = NULL,
...
static int dsp_usb_mcdt_play_para_get(struct snd_kcontrol *kcontrol,
				struct snd_ctl_elem_value *ucontrol)
{
	struct soc_bytes_ext *params = (void *)kcontrol->private_value;
	struct snd_soc_component *codec = snd_soc_kcontrol_component(kcontrol);
	...
	size = sizeof(struct usb_mcdt_play_t);
	len = params->max * sizeof(ucontrol->value.bytes.data[0]);
	if (size > len) {
		pr_err("%s size > len\n", __func__);
		return -EINVAL;
	}
	memcpy(ucontrol->value.bytes.data, &vbc_codec->usb_mcdt_play, size);

	return 0;
}

static int dsp_usb_mcdt_play_para_put(struct snd_kcontrol *kcontrol,
				struct snd_ctl_elem_value *ucontrol)
{
	struct soc_bytes_ext *params = (void *)kcontrol->private_value;
	struct snd_soc_component *codec = snd_soc_kcontrol_component(kcontrol);
	struct vbc_codec_priv *vbc_codec = snd_soc_component_get_drvdata(codec);
	int type, sample, format, chan;
	int len, size;
	int ret;
	...
	memcpy(&vbc_codec->usb_mcdt_play, ucontrol->value.bytes.data, size);

	type = vbc_codec->usb_mcdt_play.type;
	sample = vbc_codec->usb_mcdt_play.sample;
	format = vbc_codec->usb_mcdt_play.format;
	chan = vbc_codec->usb_mcdt_play.chan;

	pr_info("%s, usb_mcdt_play, type=%d, sample=%d, format=%d, chan=%d\n",
			__func__, type, sample, format, chan);

	ret = dsp_usb_mcdt_play_set(type, sample, format, chan);
	if (ret != 0)
		pr_err("%s set usb_mcdt_play failed %d\n", __func__, ret);

	return 0;
}

static int dsp_usb_mcdt_cap_para_get(struct snd_kcontrol *kcontrol,
				struct snd_ctl_elem_value *ucontrol)
{
	struct soc_bytes_ext *params = (void *)kcontrol->private_value;
	struct snd_soc_component *codec = snd_soc_kcontrol_component(kcontrol);
	...
	size = sizeof(struct usb_mcdt_cap_t);
	len = params->max * sizeof(ucontrol->value.bytes.data[0]);
	if (size > len) {
		pr_err("%s size > len\n", __func__);
		return -EINVAL;
	}
	memcpy(ucontrol->value.bytes.data, &vbc_codec->usb_mcdt_cap, size);

	return 0;
}

static int dsp_usb_mcdt_cap_para_put(struct snd_kcontrol *kcontrol,
				struct snd_ctl_elem_value *ucontrol)
{
	struct soc_bytes_ext *params = (void *)kcontrol->private_value;
	struct snd_soc_component *codec = snd_soc_kcontrol_component(kcontrol);
	...
	memcpy(&vbc_codec->usb_mcdt_cap, ucontrol->value.bytes.data, size);

	type = vbc_codec->usb_mcdt_cap.type;
	sample = vbc_codec->usb_mcdt_cap.sample;
	format = vbc_codec->usb_mcdt_cap.format;
	chan = vbc_codec->usb_mcdt_cap.chan;

	pr_info("%s, usb_mcdt_cap, type=%d, sample=%d, format=%d, chan=%d\n",
			__func__, type, sample, format, chan);

	ret = dsp_usb_mcdt_cap_set(type, sample, format, chan);
	if (ret != 0)
		pr_err("%s set usb_mcdt_cap failed %d\n", __func__, ret);

	return 0;
}

static int dsp_usb_mcdt_out_device_get(struct snd_kcontrol *kcontrol,
				     struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *codec = snd_soc_kcontrol_component(kcontrol);
	struct vbc_codec_priv *vbc_codec = snd_soc_component_get_drvdata(codec);

	ucontrol->value.integer.value[0] = vbc_codec->usb_mcdt_out_device;

	return 0;
}

static int dsp_usb_mcdt_out_device_put(struct snd_kcontrol *kcontrol,
				     struct snd_ctl_elem_value *ucontrol)
{
	u32 value;
	struct snd_soc_component *codec = snd_soc_kcontrol_component(kcontrol);
	...
	value = ucontrol->value.integer.value[0];
	sp_asoc_pr_dbg("%s, value=%d\n", __func__, value);
	vbc_codec->usb_mcdt_out_device = value;
	dsp_usb_mcdt_out_device_set(value);

	return value;
}

static int dsp_usb_mcdt_in_device_get(struct snd_kcontrol *kcontrol,
				     struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *codec = snd_soc_kcontrol_component(kcontrol);
	struct vbc_codec_priv *vbc_codec = snd_soc_component_get_drvdata(codec);

	ucontrol->value.integer.value[0] = vbc_codec->usb_mcdt_in_device;

	return 0;
}

static int dsp_usb_mcdt_in_device_put(struct snd_kcontrol *kcontrol,
				     struct snd_ctl_elem_value *ucontrol)
{
	u32 value;
	struct snd_soc_component *codec = snd_soc_kcontrol_component(kcontrol);
	...
	value = ucontrol->value.integer.value[0];
	sp_asoc_pr_dbg("%s, value=%d\n", __func__, value);
	vbc_codec->usb_mcdt_in_device = value;
	dsp_usb_mcdt_in_device_set(value);

	return value;
}

static int dsp_usb_mcdt_moudle_en_get(struct snd_kcontrol *kcontrol,
				     struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *codec = snd_soc_kcontrol_component(kcontrol);
	struct vbc_codec_priv *vbc_codec = snd_soc_component_get_drvdata(codec);

	ucontrol->value.integer.value[0] = vbc_codec->usb_mcdt_moudle_en;

	return 0;
}

static int dsp_usb_mcdt_moudle_en_put(struct snd_kcontrol *kcontrol,
				     struct snd_ctl_elem_value *ucontrol)
{
	u32 value;
	struct snd_soc_component *codec = snd_soc_kcontrol_component(kcontrol);
	...
	value = ucontrol->value.integer.value[0];
	sp_asoc_pr_dbg("%s, value=%d\n", __func__, value);
	vbc_codec->usb_mcdt_moudle_en = value;
	dsp_usb_mcdt_moudle_en_set(value);
...
static const struct snd_kcontrol_new vbc_codec_snd_controls[] = {
	...
	/* USB_OFFLOAD */
	SND_SOC_BYTES_EXT("DSP_USB_MCDT_PLAY_PARA", 20,
		dsp_usb_mcdt_play_para_get, dsp_usb_mcdt_play_para_put),
	SND_SOC_BYTES_EXT("DSP_USB_MCDT_CAP_PARA", 20,
		dsp_usb_mcdt_cap_para_get, dsp_usb_mcdt_cap_para_put),
	SOC_SINGLE_EXT("DSP_USB_MCDT_OUT_DEVICE",
		       SND_SOC_NOPM, 0,
		       MAX_32_BIT, 0,
		       dsp_usb_mcdt_out_device_get,
		       dsp_usb_mcdt_out_device_put),
	SOC_SINGLE_EXT("DSP_USB_MCDT_IN_DEVICE",
		       SND_SOC_NOPM, 0,
		       MAX_32_BIT, 0,
		       dsp_usb_mcdt_in_device_get,
...
static void init_vbc_codec_data(struct vbc_codec_priv *vbc_codec)
{
	...
	/* usb_ref_set */
	vbc_codec->usb_scene_data.ref_usb_en[0] =0;
	vbc_codec->usb_scene_data.ref_usb_en[1] =0;
...
static int sprd_dai_vbc_probe(struct snd_soc_dai *dai)
{
	...
	if (!dai || !dai->driver || dai->driver->id >= BE_DAI_ID_MAX) {
		pr_err("%s Invalid params\n", __func__);
		return -EINVAL;
	}
	memset(&intercon, 0, sizeof(intercon));
	if (dai->driver->playback.stream_name &&
	    be_dai_id_aif_name_playback[dai->driver->id]) {
	...
	if (dai->driver->capture.stream_name &&
	    be_dai_id_aif_name_capture[dai->driver->id]) {
		dev_dbg(dai->dev, "%s: add route for widget %s",
...
void usb_play_add_ref(struct vbc_codec_priv *vbc_codec, int stream)
{
	int ref;
...
void usb_cap_add_ref(struct vbc_codec_priv *vbc_codec, int stream)
{
	int ref;
...
static int normal_suspend(struct snd_soc_component *component)
{
	bool only_play;
	struct aud_pm_vbc *pm_vbc;
	struct snd_soc_dai *dai;
	bool is_normal_scene = false;
	pm_vbc = aud_pm_vbc_get();

	if (!component->active)
		return 0;

	/* we need to confirm the dai is active first*/
	/* and then confirm the scene is normal playback */
...
static int normal_resume(struct snd_soc_component *component)
{
	bool only_play;
	struct aud_pm_vbc *pm_vbc;
	struct snd_soc_dai *dai;
