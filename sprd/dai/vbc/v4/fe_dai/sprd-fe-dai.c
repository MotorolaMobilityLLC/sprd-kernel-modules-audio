...
static struct sprd_pcm_dma_params pcm_hifi_fast_play_mcdt;
...
static char *fe_dai_id_aif_name_playback[FE_DAI_ID_MAX] = {
	[FE_DAI_ID_NORMAL_AP01] = "FE_IF_NORMAL_AP01_P",
	[FE_DAI_ID_NORMAL_AP23] = "FE_IF_NORMAL_AP23_P",
	[FE_DAI_ID_CAPTURE_DSP] = NULL,
	[FE_DAI_ID_FAST_P] = "FE_IF_FAST_P",
	[FE_DAI_ID_OFFLOAD] = "FE_IF_OFFLOAD_P",
	[FE_DAI_ID_VOICE] = "FE_IF_VOICE_P",
	[FE_DAI_ID_VOIP] = "FE_IF_VOIP_P",
	[FE_DAI_ID_FM] = "FE_IF_FM_P",
	[FE_DAI_ID_FM_CAPTURE_AP] = NULL,
	[FE_DAI_ID_VOICE_CAPTURE] = NULL,
	[FE_DAI_ID_LOOP] = "FE_IF_LOOP_P",
	[FE_DAI_ID_A2DP_OFFLOAD] = "FE_IF_A2DP_OFFLOAD_P",
	[FE_DAI_ID_A2DP_PCM] = "FE_IF_A2DP_PCM_P",
	[FE_DAI_ID_FM_CAP_DSP] = NULL,
	[FE_DAI_ID_BTSCO_CAP_DSP] = NULL,
	[FE_DAI_ID_FM_DSP] = "FE_IF_FM_DSP_P",
	[FE_DAI_ID_DUMP] = NULL,
	[FE_DAI_ID_BTSCO_CAP_AP] = NULL,
	[FE_DAI_ID_HFP] = "FE_IF_HFP_P",
	[FE_DAI_ID_RECOGNISE_CAPTURE] = NULL,
...
static char *fe_dai_id_aif_name_capture[FE_DAI_ID_MAX] = {
	[FE_DAI_ID_NORMAL_AP01] = "FE_IF_NORMAL_AP01_C",
	[FE_DAI_ID_NORMAL_AP23] = "FE_IF_NORMAL_AP23_C",
	[FE_DAI_ID_CAPTURE_DSP] = "FE_IF_CAP_DSP_C",
	[FE_DAI_ID_FAST_P] = NULL,
	[FE_DAI_ID_OFFLOAD] = NULL,
	[FE_DAI_ID_VOICE] = "FE_IF_VOICE_C",
	[FE_DAI_ID_VOIP] = "FE_IF_VOIP_C",
	[FE_DAI_ID_FM] = NULL,
	[FE_DAI_ID_FM_CAPTURE_AP] = "FE_IF_FM_CAP_C",
	[FE_DAI_ID_VOICE_CAPTURE] = "FE_IF_VOICE_CAP_C",
	[FE_DAI_ID_LOOP] = "FE_IF_LOOP_C",
	[FE_DAI_ID_A2DP_OFFLOAD] = NULL,
	[FE_DAI_ID_A2DP_PCM] = NULL,
	[FE_DAI_ID_FM_CAP_DSP] = "FE_IF_FM_CAP_DSP_C",
	[FE_DAI_ID_BTSCO_CAP_DSP] = "FE_IF_BTSCO_CAP_DSP_C",
	[FE_DAI_ID_FM_DSP] = NULL,
	[FE_DAI_ID_DUMP] = "FE_IF_DUMP_C",
	[FE_DAI_ID_BTSCO_CAP_AP] = "FE_IF_BTCAP_AP_C",
	[FE_DAI_ID_HFP] = "FE_IF_HFP_C",
	[FE_DAI_ID_RECOGNISE_CAPTURE] = "FE_IF_RECOGNISE_CAP_C",
	[FE_DAI_ID_VOICE_PCM_P] = NULL,
...
static void mcdt_dma_deinit(struct snd_soc_dai *fe_dai, int stream)
{
	...
	case FE_DAI_ID_HIFI_FAST_P:
		mcdt_dac_dma_disable(MCDT_CHAN_HIFI_FAST_PLAY);
		break;
	case FE_DAI_ID_VOIP:
		if (is_playback)
...
static int mcdt_dma_config_init(struct snd_soc_dai *fe_dai, int stream)
{
	...
	case FE_DAI_ID_FAST_P:
		...
		break;
	case FE_DAI_ID_HIFI_FAST_P:
		uid = mcdt_dac_dma_enable(MCDT_CHAN_HIFI_FAST_PLAY,
			MCDT_EMPTY_WMK_HIFI_FAST_PLAY);
		pcm_hifi_fast_play_mcdt.channels[0] = uid;
		break;
	case FE_DAI_ID_VOIP:
		if (is_playback) {
	...
	struct snd_pcm_hw_params *params, struct snd_soc_dai *fe_dai)
{
	...
	case FE_DAI_ID_HIFI_FAST_P:
		/*fast playback*/
		pcm_hifi_fast_play_mcdt.name = "VBC PCM HIFI Fast P";
		pcm_hifi_fast_play_mcdt.irq_type = SPRD_DMA_BLK_INT;
		pcm_hifi_fast_play_mcdt.desc.datawidth =
			DMA_SLAVE_BUSWIDTH_4_BYTES;
		pcm_hifi_fast_play_mcdt.desc.fragmens_len = MCDT_HIFI_FAST_PLAY_FRAGMENT;
		pcm_hifi_fast_play_mcdt.use_mcdt = 1;
		pcm_hifi_fast_play_mcdt.dev_paddr[0] =
			mcdt_dac_dma_phy_addr(MCDT_CHAN_HIFI_FAST_PLAY);
		pcm_hifi_fast_play_mcdt.used_dma_channel_name[0] = "hifi_fast_p";
		break;
	case FE_DAI_ID_VOIP:
		if (is_playback) {
			/*voip play*/
	...
	int stream)
{
	...
	case FE_DAI_ID_FAST_P:
		...
		break;
	case FE_DAI_ID_HIFI_FAST_P:
		dma_data = &pcm_hifi_fast_play_mcdt;
		break;
	case FE_DAI_ID_VOIP:
...
/* add route for {aif_name, NULL, stream_name} */
static int fe_dai_probe(struct snd_soc_dai *fe_dai)
{
	struct snd_soc_dapm_route intercon;
	struct snd_soc_dapm_context *dapm;

	if (!fe_dai || !fe_dai->driver || fe_dai->driver->id >= FE_DAI_ID_MAX) {
	...
	if (fe_dai->driver->playback.stream_name &&
		fe_dai_id_aif_name_playback[fe_dai->driver->id]) {
	...
	if (fe_dai->driver->capture.stream_name &&
		fe_dai_id_aif_name_capture[fe_dai->driver->id]) {
		dev_dbg(fe_dai->dev, "%s add route for widget %s",
...
static struct snd_soc_dai_driver sprd_fe_dais[FE_DAI_ID_MAX] = {
	...
	/* 23: FE_DAI_ID_HIFI_FAST_P */
	{
		.id = FE_DAI_ID_HIFI_FAST_P,
		.name = TO_STRING(FE_DAI_ID_HIFI_FAST_P),
		.probe = fe_dai_probe,
		.playback = {
			.stream_name = "FE_DAI_HIFI_FAST_P",
			.rates = SNDRV_PCM_RATE_CONTINUOUS,
			.formats = (SNDRV_PCM_FMTBIT_S16_LE |
						SNDRV_PCM_FMTBIT_S24_LE),
			.channels_min = 1,
