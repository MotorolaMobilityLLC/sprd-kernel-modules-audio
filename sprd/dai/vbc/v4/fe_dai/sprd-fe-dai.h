...
#if defined(CONFIG_UNISOC_AUDIO_MCDT_N6L)
#define MCDT_CHAN_LOOP MCDT_CHAN0
#else
...
#define MCDT_FAST_PLAY_FRAGMENT 120

/* FE_DAI_ID_HIFI_FAST_P: use MCDT_CHAN10 playback path */
#if defined(CONFIG_UNISOC_AUDIO_MCDT_N6L)
#define MCDT_CHAN_HIFI_FAST_PLAY MCDT_CHAN9
#else
...
#define MCDT_DSPCAP_FRAGMENT_SINGLE_CHAN 40
...
/* FE_DAI_ID_BTSCO_CAP_DSP: same as FE_DAI_ID_CAPTURE_DSP */
#define MCDT_CHAN_DSP_VAD_CAP MCDT_CHAN4
#define MCDT_FULL_WMK_DSP_VAD_CAP 320
#define MCDT_DSPVADCAP_FRAGMENT 80
