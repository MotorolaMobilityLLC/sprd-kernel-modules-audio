...
enum SPRD_BE_SWITCH {
	...
	S_DSP_HIFI_FAST_P,
	S_AGCP_IIS0_TX,
	S_NORMAL_AP01_P_USB_MCDT,
	S_NORMAL_AP01_C_USB_MCDT,
	S_NORMAL_AP23_P_USB_MCDT,
	S_NORMAL_AP23_C_USB_MCDT,
	S_CAPTURE_DSP_USB_MCDT,
	S_FAST_P_USB_MCDT,
	S_OFFLOAD_USB_MCDT,
	S_VOICE_P_USB_MCDT,
	S_VOICE_C_USB_MCDT,
...
static const struct snd_kcontrol_new sprd_audio_be_switch[S_SWITCH_CASE_MAX] = {
	...
	[S_NORMAL_AP01_P_USB_MCDT] = SOC_DAPM_SINGLE("SWITCH", SND_SOC_NOPM, 0,
		1, 0),
	[S_NORMAL_AP01_C_USB_MCDT] = SOC_DAPM_SINGLE("SWITCH", SND_SOC_NOPM, 0,
		1, 0),
	[S_NORMAL_AP23_P_USB_MCDT] = SOC_DAPM_SINGLE("SWITCH", SND_SOC_NOPM, 0,
		1, 0),
	[S_NORMAL_AP23_C_USB_MCDT] = SOC_DAPM_SINGLE("SWITCH", SND_SOC_NOPM, 0,
		1, 0),
	[S_CAPTURE_DSP_USB_MCDT] = SOC_DAPM_SINGLE("SWITCH", SND_SOC_NOPM, 0,
		1, 0),
	[S_FAST_P_USB_MCDT] = SOC_DAPM_SINGLE("SWITCH", SND_SOC_NOPM, 0,
		1, 0),
	[S_OFFLOAD_USB_MCDT] = SOC_DAPM_SINGLE("SWITCH", SND_SOC_NOPM, 0,
		1, 0),
	[S_VOICE_P_USB_MCDT] = SOC_DAPM_SINGLE("SWITCH", SND_SOC_NOPM, 0,
		1, 0),
	[S_VOICE_C_USB_MCDT] = SOC_DAPM_SINGLE("SWITCH", SND_SOC_NOPM, 0,
		1, 0),
	[S_VOIP_P_USB_MCDT] = SOC_DAPM_SINGLE("SWITCH", SND_SOC_NOPM, 0,
		1, 0),
	[S_VOIP_C_USB_MCDT] = SOC_DAPM_SINGLE("SWITCH", SND_SOC_NOPM, 0,
		1, 0),
	[S_FM_USB_MCDT] = SOC_DAPM_SINGLE("SWITCH", SND_SOC_NOPM, 0,
		1, 0),
	[S_LOOP_P_USB_MCDT] = SOC_DAPM_SINGLE("SWITCH", SND_SOC_NOPM, 0,
		1, 0),
	[S_LOOP_C_USB_MCDT] = SOC_DAPM_SINGLE("SWITCH", SND_SOC_NOPM, 0,
		1, 0),
...
static const struct snd_soc_dapm_widget sprd_pcm_routing_widgets[] = {
	...
	SND_SOC_DAPM_AIF_OUT("FE_IF_NORMAL_AP23_C", "FE_DAI_NORMAL_AP23_C",
		0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_OUT("FE_IF_CAP_DSP_C", "FE_DAI_CAP_DSP_C", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("FE_IF_FAST_P", "FE_DAI_FAST_P", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("FE_IF_HIFI_FAST_P", "FE_DAI_ID_HIFI_FAST_P", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("FE_IF_OFFLOAD_P", "FE_DAI_OFFLOAD_P", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("FE_IF_VOICE_P", "FE_DAI_VOICE_P", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_OUT("FE_IF_VOICE_C", "FE_DAI_VOICE_C", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("FE_IF_VOIP_P", "FE_DAI_VOIP_P", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_OUT("FE_IF_VOIP_C", "FE_DAI_VOIP_C", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("FE_IF_FM_P", "FE_DAI_FM_P", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("FE_IF_FM_DSP_P", "FE_DAI_FM_DSP_P", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_OUT("FE_IF_FM_CAP_C", "FE_DAI_FM_CAP_C", 0, SND_SOC_NOPM, 0, 0),
	...
	SND_SOC_DAPM_AIF_OUT("FE_IF_VOICE_CAP_C", "FE_DAI_VOICE_CAP_C",
		0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("FE_IF_LOOP_P", "FE_DAI_LOOP_P", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_OUT("FE_IF_LOOP_C", "FE_DAI_LOOP_C", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("FE_IF_A2DP_OFFLOAD_P", "FE_DAI_A2DP_OFFLOAD_P",
		0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("FE_IF_A2DP_PCM_P", "FE_DAI_A2DP_PCM_P",
		0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_OUT("FE_IF_DUMP_C", "FE_DAI_DUMP_C", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_OUT("FE_IF_BTCAP_AP_C", "FE_DAI_BTCAP_AP_C",
		0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("FE_IF_HFP_P", "FE_DAI_HFP_P", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_OUT("FE_IF_HFP_C", "FE_DAI_HFP_C", 0, SND_SOC_NOPM, 0, 0),
	...
	SND_SOC_DAPM_AIF_IN("FE_IF_VOICE_PCM_P", "FE_DAI_VOICE_PCM_P",
		0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("FE_IF_HIFI_P", "FE_DAI_HIFI_P", 0, SND_SOC_NOPM, 0, 0),
	...
	SND_SOC_DAPM_AIF_OUT("BE_IF_NORMAL_AP01_CODEC_C",
		"BE_DAI_NORMAL_AP01_CODEC_C", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("BE_IF_NORMAL_AP23_CODEC_P",
		"BE_DAI_NORMAL_AP23_CODEC_P", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_OUT("BE_IF_NORMAL_AP23_CODEC_C",
		"BE_DAI_NORMAL_AP23_CODEC_C", 0, SND_SOC_NOPM, 0, 0),
	...
	SND_SOC_DAPM_AIF_OUT("BE_IF_VOIP_USB_C", "BE_DAI_VOIP_USB_C",
		0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("BE_IF_FM_USB_P", "BE_DAI_FM_USB_P", 0, SND_SOC_NOPM, 0, 0),
	...
	SND_SOC_DAPM_AIF_OUT("BE_IF_VOICE_BT_C", "BE_DAI_VOICE_BT_C",
		0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("BE_IF_VOIP_BT_P", "BE_DAI_VOIP_BT_P", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_OUT("BE_IF_VOIP_BT_C", "BE_DAI_VOIP_BT_C", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("BE_IF_LOOP_BT_P", "BE_DAI_LOOP_BT_P", 0, SND_SOC_NOPM, 0, 0),
	...
	SND_SOC_DAPM_AIF_IN("BE_IF_NORMAL_AP01_BTSCO_P",
			    "BE_DAI_NORMAL_AP01_BTSCO_P", 0, SND_SOC_NOPM, 0, 0),
	...
	SND_SOC_DAPM_AIF_OUT("BE_IF_CAP_DSP_BTSCO_C", "BE_DAI_CAP_DSP_BTSCO_C",
		0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_OUT("BE_IF_DUMP_C", "BE_DAI_DUMP_C", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("BE_IF_HFP_P", "BE_DAI_HFP_P", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_OUT("BE_IF_HFP_C", "BE_DAI_HFP_C", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_OUT("BE_IF_CAP_RECOGNISE_CODEC_C",
			    "BE_DAI_CAP_RECOGNISE_CODEC_C", 0, SND_SOC_NOPM, 0, 0),
	...
	SND_SOC_DAPM_AIF_OUT("AGCP_IIS0_TX", "AGCP_IIS0_TX Playback",
			    0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("BE_IF_NORMAL_AP01_USB_P_MCDT",
		"BE_DAI_NORMAL_AP01_USB_P_MCDT", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_OUT("BE_IF_NORMAL_AP01_USB_C_MCDT",
		"BE_DAI_NORMAL_AP01_USB_C_MCDT",
		0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("BE_IF_NORMAL_AP23_USB_P_MCDT",
		"BE_DAI_NORMAL_AP23_USB_P_MCDT", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_OUT("BE_IF_NORMAL_AP23_USB_C_MCDT",
		"BE_DAI_NORMAL_AP23_USB_C_MCDT", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_OUT("BE_IF_CAP_DSP_USB_C_MCDT", "BE_DAI_CAP_DSP_USB_C_MCDT",
		0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("BE_IF_FAST_USB_P_MCDT", "BE_DAI_FAST_USB_P_MCDT",
		0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("BE_IF_OFFLOAD_USB_P_MCDT", "BE_DAI_OFFLOAD_USB_P_MCDT",
		-1, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("BE_IF_VOICE_USB_P_MCDT", "BE_DAI_VOICE_USB_P_MCDT",
		0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_OUT("BE_IF_VOICE_USB_C_MCDT", "BE_DAI_VOICE_USB_C_MCDT",
		0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("BE_IF_VOIP_USB_P_MCDT", "BE_DAI_VOIP_USB_P_MCDT",
		0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_OUT("BE_IF_VOIP_USB_C_MCDT", "BE_DAI_VOIP_USB_C_MCDT",
		0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("BE_IF_FM_USB_P_MCDT", "BE_DAI_FM_USB_P_MCDT", 0, SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_AIF_IN("BE_IF_FM_DSP_USB_P_MCDT", "BE_DAI_FM_DSP_USB_P_MCDT",
		0, SND_SOC_NOPM, 0, 0),
	...
	SND_SOC_DAPM_SWITCH("S_NORMAL_AP01_P_USB_MCDT", SND_SOC_NOPM,
		0, 0, &sprd_audio_be_switch[S_NORMAL_AP01_P_USB_MCDT]),
	SND_SOC_DAPM_SWITCH("S_NORMAL_AP01_C_USB_MCDT", SND_SOC_NOPM,
		0, 0, &sprd_audio_be_switch[S_NORMAL_AP01_C_USB_MCDT]),
	SND_SOC_DAPM_SWITCH("S_NORMAL_AP23_P_USB_MCDT", SND_SOC_NOPM,
		0, 0, &sprd_audio_be_switch[S_NORMAL_AP23_P_USB_MCDT]),
	SND_SOC_DAPM_SWITCH("S_NORMAL_AP23_C_USB_MCDT", SND_SOC_NOPM,
		0, 0, &sprd_audio_be_switch[S_NORMAL_AP23_C_USB_MCDT]),
	SND_SOC_DAPM_SWITCH("S_CAPTURE_DSP_USB_MCDT", SND_SOC_NOPM,
		0, 0, &sprd_audio_be_switch[S_CAPTURE_DSP_USB_MCDT]),
	SND_SOC_DAPM_SWITCH("S_FAST_P_USB_MCDT", SND_SOC_NOPM,
		0, 0, &sprd_audio_be_switch[S_FAST_P_USB_MCDT]),
	SND_SOC_DAPM_SWITCH("S_OFFLOAD_USB_MCDT", SND_SOC_NOPM,
		0, 0, &sprd_audio_be_switch[S_OFFLOAD_USB_MCDT]),
	SND_SOC_DAPM_SWITCH("S_VOICE_P_USB_MCDT", SND_SOC_NOPM,
		0, 0, &sprd_audio_be_switch[S_VOICE_P_USB_MCDT]),
	SND_SOC_DAPM_SWITCH("S_VOICE_C_USB_MCDT", SND_SOC_NOPM,
		0, 0, &sprd_audio_be_switch[S_VOICE_C_USB_MCDT]),
	SND_SOC_DAPM_SWITCH("S_VOIP_P_USB_MCDT", SND_SOC_NOPM,
		0, 0, &sprd_audio_be_switch[S_VOIP_P_USB_MCDT]),
	SND_SOC_DAPM_SWITCH("S_VOIP_C_USB_MCDT", SND_SOC_NOPM,
		0, 0, &sprd_audio_be_switch[S_VOIP_C_USB_MCDT]),
	SND_SOC_DAPM_SWITCH("S_FM_USB_MCDT", SND_SOC_NOPM,
		0, 0, &sprd_audio_be_switch[S_FM_USB_MCDT]),
	SND_SOC_DAPM_SWITCH("S_LOOP_P_USB_MCDT", SND_SOC_NOPM,
		0, 0, &sprd_audio_be_switch[S_LOOP_P_USB_MCDT]),
	SND_SOC_DAPM_SWITCH("S_LOOP_C_USB_MCDT", SND_SOC_NOPM,
...
static const struct snd_soc_dapm_route sprd_pcm_routing_intercon[] = {
	...
	/* S_NORMAL_AP01_P_USB_MCDT */
	{"S_NORMAL_AP01_P_USB_MCDT", "SWITCH", "FE_IF_NORMAL_AP01_P"},
	{"BE_IF_NORMAL_AP01_USB_P_MCDT", NULL, "S_NORMAL_AP01_P_USB_MCDT"},
	/* S_NORMAL_AP01_C_USB_MCDT */
	{"S_NORMAL_AP01_C_USB_MCDT", "SWITCH", "BE_IF_NORMAL_AP01_USB_C_MCDT"},
	{"FE_IF_NORMAL_AP01_C", NULL, "S_NORMAL_AP01_C_USB_MCDT"},
	/* S_NORMAL_AP23_P_USB_MCDT */
	{"S_NORMAL_AP23_P_USB_MCDT", "SWITCH", "FE_IF_NORMAL_AP23_P"},
	{"BE_IF_NORMAL_AP23_USB_P_MCDT", NULL, "S_NORMAL_AP23_P_USB_MCDT"},
	/* S_NORMAL_AP23_C_USB_MCDT */
	{"S_NORMAL_AP23_C_USB_MCDT", "SWITCH", "BE_IF_NORMAL_AP23_USB_C_MCDT"},
	{"FE_IF_NORMAL_AP23_C", NULL, "S_NORMAL_AP23_C_USB_MCDT"},
	/* S_CAPTURE_DSP_USB_MCDT */
	{"S_CAPTURE_DSP_USB_MCDT", "SWITCH", "BE_IF_CAP_DSP_USB_C_MCDT"},
	{"FE_IF_CAP_DSP_C", NULL, "S_CAPTURE_DSP_USB_MCDT"},
	/* S_FAST_P_USB_MCDT */
	{"S_FAST_P_USB_MCDT", "SWITCH", "FE_IF_FAST_P"},
	{"BE_IF_FAST_USB_P_MCDT", NULL, "S_FAST_P_USB_MCDT"},
	/* S_OFFLOAD_USB_MCDT */
	{"S_OFFLOAD_USB_MCDT", "SWITCH", "FE_IF_OFFLOAD_P"},
	{"BE_IF_OFFLOAD_USB_P_MCDT", NULL, "S_OFFLOAD_USB_MCDT"},
	/* S_VOICE_P_USB_MCDT */
	{"S_VOICE_P_USB_MCDT", "SWITCH", "FE_IF_VOICE_P"},
	{"BE_IF_VOICE_USB_P_MCDT", NULL, "S_VOICE_P_USB_MCDT"},
	/* S_VOICE_C_USB_MCDT */
	{"S_VOICE_C_USB_MCDT", "SWITCH", "BE_IF_VOICE_USB_C_MCDT"},
	{"FE_IF_VOICE_C", NULL, "S_VOICE_C_USB_MCDT"},
	/* S_VOIP_P_USB_MCDT */
	{"S_VOIP_P_USB_MCDT", "SWITCH", "FE_IF_VOIP_P"},
	{"BE_IF_VOIP_USB_P_MCDT", NULL, "S_VOIP_P_USB_MCDT"},
	/* S_VOIP_C_USB_MCDT */
	{"S_VOIP_C_USB_MCDT", "SWITCH", "BE_IF_VOIP_USB_C_MCDT"},
	{"FE_IF_VOIP_C", NULL, "S_VOIP_C_USB_MCDT"},
	/* S_FM_USB_MCDT */
	{"S_FM_USB_MCDT", "SWITCH", "FE_IF_FM_P"},
	{"BE_IF_FM_USB_P_MCDT", NULL, "S_FM_USB_MCDT"},
	/* S_LOOP_P_USB_MCDT */
	{"S_LOOP_P_USB_MCDT", "SWITCH", "FE_IF_LOOP_P"},
	{"BE_IF_LOOP_USB_P_MCDT", NULL, "S_LOOP_P_USB_MCDT"},
	/* S_LOOP_C_USB_MCDT */
	{"S_LOOP_C_USB_MCDT", "SWITCH", "BE_IF_LOOP_USB_C_MCDT"},
	{"FE_IF_LOOP_C", NULL, "S_LOOP_C_USB_MCDT"},
	/* S_FM_DSP_USB_MCDT */
