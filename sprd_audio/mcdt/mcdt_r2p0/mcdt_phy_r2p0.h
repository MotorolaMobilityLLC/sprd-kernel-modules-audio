...
#ifndef _MCDT_CTL_REG_R2P0_H
#define _MCDT_CTL_REG_R2P0_H
...
#define MCDT_CH10_TXD     0X0028

#define MCDT_CH0_RXD     0X002c
#define MCDT_CH1_RXD     0X0030
#define MCDT_CH2_RXD     0X0034
#define MCDT_CH3_RXD     0X0038
#define MCDT_CH4_RXD     0X003c
#define MCDT_CH5_RXD     0X0040
#define MCDT_CH6_RXD     0X0044
#define MCDT_CH7_RXD     0X0048
#define MCDT_CH8_RXD     0X004c
...
#define MCDT_DAC10_WTMK  0x0088

#define MCDT_ADC0_WTMK   0x008c
#define MCDT_ADC1_WTMK   0x0090
#define MCDT_ADC2_WTMK   0x0094
#define MCDT_ADC3_WTMK   0x0098
#define MCDT_ADC4_WTMK   0x009c
#define MCDT_ADC5_WTMK   0x00a0
#define MCDT_ADC6_WTMK   0x00a4
#define MCDT_ADC7_WTMK   0x00a8
#define MCDT_ADC8_WTMK   0x00ac
...
#define MCDT_DAC1_FIFO_ADDR_ST    0x00e8
#define MCDT_DAC2_FIFO_ADDR_ST    0x00ec
#define MCDT_DAC3_FIFO_ADDR_ST    0x00f0
#define MCDT_DAC4_FIFO_ADDR_ST    0x00f4
#define MCDT_DAC5_FIFO_ADDR_ST    0x00f8
#define MCDT_DAC6_FIFO_ADDR_ST    0x00fc
#define MCDT_DAC7_FIFO_ADDR_ST    0x0100
#define MCDT_DAC8_FIFO_ADDR_ST    0x0104
#define MCDT_DAC9_FIFO_ADDR_ST    0x0108
#define MCDT_DAC10_FIFO_ADDR_ST   0x010c
#define MCDT_ADC0_FIFO_ADDR_ST    0x0110
#define MCDT_ADC1_FIFO_ADDR_ST    0x0114
#define MCDT_ADC2_FIFO_ADDR_ST    0x0118
#define MCDT_ADC3_FIFO_ADDR_ST    0x011c
#define MCDT_ADC4_FIFO_ADDR_ST    0x0120
#define MCDT_ADC5_FIFO_ADDR_ST    0x0124
#define MCDT_ADC6_FIFO_ADDR_ST    0x0128
#define MCDT_ADC7_FIFO_ADDR_ST    0x012c
#define MCDT_ADC8_FIFO_ADDR_ST    0x0130
...
#define MCDT_INT_MSK_CFG2    0X0148

#define MCDT_DMA_REQ_CFG0    0X014c
#define MCDT_DMA_REQ_CFG1    0X0150
#define MCDT_DMA_REQ_CFG2    0X0154

#define MCDT_FIFO_CLR    0X0158

#define MCDT_DMA_ACK_CFG0    0X015c
#define MCDT_DMA_ACK_CFG1    0X0160
#define MCDT_DMA_ACK_CFG2    0X0164
...
#define BIT_MCDT_ADC_DMA_CH3_SEL0(x)    (((x) & GENMASK(3, 0)) << 24)
#define BIT_GET_MCDT_ADC_DMA_CH3_SEL0(x)    (((x) >> 12) & GENMASK(3, 0))
#define BIT_MCDT_ADC_DMA_CH2_SEL0(x)    (((x) & GENMASK(3, 0)) << 20)
#define BIT_GET_MCDT_ADC_DMA_CH2_SEL0(x)    (((x) >> 8) & GENMASK(3, 0))
#define BIT_MCDT_ADC_DMA_CH1_SEL0(x)    (((x) & GENMASK(3, 0)) << 16)
