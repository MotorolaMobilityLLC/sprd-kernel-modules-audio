...
EXPORT_SYMBOL(audio_sblock_poll_wait);
...
EXPORT_SYMBOL(audio_sblock_init);
...
EXPORT_SYMBOL(audio_sblock_destroy);
...
EXPORT_SYMBOL(audio_sblock_get);
...
EXPORT_SYMBOL(audio_sblock_send);
...
EXPORT_SYMBOL(audio_sblock_receive);
